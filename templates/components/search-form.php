<div class="relative">
    <form role="search" method="get" class="flex items-center" action="<?= esc_url(home_url('/')); ?>">
        <div class="relative flex items-center gap-8">
            ...
            <input type="search" id="search-input" placeholder="<?= esc_attr__('Search', 'textdomain'); ?>" name="s"
                ...
                class="flex-1 py-2 pl-4 pr-12 h-10 text-black rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-transparent transition min-w-full lg:min-w-[25rem] live-search-input"
                autocomplete="off" />
            <button type="submit"
    ...
    <div class="absolute left-0 z-20 flex-col hidden w-full gap-4 p-8 mt-2 bg-white border border-gray-200 shadow-md rounded-b-md live-search-results"
        aria-live="polite">
