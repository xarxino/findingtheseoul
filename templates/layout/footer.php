<footer>
    <?php include(locate_template('templates/components/newsletter-form.php')); ?>
    <div class="flex flex-col gap-12 py-24 text-white bg-black">
        <div class="container flex justify-between gap-4">
            <div class="flex justify-between gap-16">
                <div class="flex flex-col gap-4">
                    <h4 class="text-base font-bold leading-none uppercase font-sans">Explore Korea</h4>
                ...
                <div class="flex flex-col gap-4">
                    <h4 class="text-base font-bold leading-none uppercase font-sans">K-Food</h4>
                    <ul class="flex flex-col gap-4">
                        <li>
                ...
                <div class="flex flex-col gap-4">
                    <h4 class="text-base font-bold leading-none uppercase font-sans">Resources</h4>
                    <ul class="flex flex-col gap-4">
                        <li>
            ...
            <div class="flex flex-col gap-4">
                <h4 class="text-base font-bold leading-none uppercase font-sans">Contact us</h4>
                <div class="flex flex-col gap-4">
