                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <?php if (has_post_thumbnail()): ?>
                        <a href="<?php the_permalink(); ?>">
                            <img class="w-full h-48 object-cover" src="<?php the_post_thumbnail_url('medium'); ?>"
                                alt="<?php the_title(); ?>">
                        </a>
                    <?php endif; ?>
                    <div class="p-4">
                        ...
                        <a href="<?php the_permalink(); ?>"
                            class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded"><?php _e('Read more', 'textdomain'); ?></a>
                    </div>
                </div>
            <?php endwhile; ?>
        </div>
